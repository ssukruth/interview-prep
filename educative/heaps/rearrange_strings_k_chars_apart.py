...
"""
- get a frequency map of each char
- build a max heap of type (freq, char)
- while heap:
    - pop to get char & freq
    - add char to result string
    - decrement freq and add (char, freq) to a queue
    - if queue size is k:
        - pop char & freq and add to heap
"""
def main():
